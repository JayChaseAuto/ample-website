...
const NEW_PRODUCTS = [
  ...
  makeProduct({
    ...
    bullets: [
      ‘Hall-effect. No resistive drift, no resistance ladder to fail.’,
      ‘OEM electrical interface. Drops into the harness the original used.’,
      ‘Sealed against road salt, brake dust and pressure wash.’,
      ‘Calibrated output. Clean signal from 1 km/h to top speed.’,
      ‘Direct replacement — no recalibration, no scan-tool reset.’,
      ‘Two-year replacement warranty.’,
    ],
    ...
    benefits: [
      ...
      { icon: ‘shield’,    body: ‘IP67 sealed. Salt, dust and pressure wash can’t reach the element or the connector.’ },
    ...
    outro: ‘Each sensor is bench-tested for signal linearity across the speed range and pull-tested at the connector seal before it ships. Built on the line that supplies our OE brake program, the same QC standard that backs every Gold Standard Braking SKU in the range.’,
  }),
  makeProduct({
    slug: 'pad-sensor',
  ...
  makeProduct({
    ...
    heroAsset: ‘radiator’,
    summary: ‘Brass-tube heater core. The part nobody thinks about until there’s a sweet smell in the cabin, fog on the inside of the glass, and coolant on the passenger carpet.’,
    bullets: [
    ...
    closing: ‘Heater cores fail slowly: a pinhole opens, coolant weeps into the evaporator box, and by the time there’s fog on the inside of the windshield the carpet is already wet. Brass tubes and pressure-tested joints close off the failure mode at the source.’,
